...
<div class="main-menu menu-fixed {{(($configData['theme'] === 'dark') || ($configData['theme'] === 'semi-dark')) ? 'menu-dark' : 'menu-light'}} menu-accordion menu-shadow" data-scroll-to-active="true">
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      {{-- Configurando os menus para cada perfil --}}
      @if (Auth::user()->tipo == 1) {{-- Administrador --}}
        @php
      ...
      @if (Auth::user()->tipo == 2) {{-- Operador --}}
        @php
            $verticalMenuJson = file_get_contents(base_path('resources/data/menu-data/verticalMenuOperador.json'));
            $verticalMenuData = json_decode($verticalMenuJson);
            $menuData = [$verticalMenuData,];
        @endphp  
      @endif
      {{-- Fim da configuracao dos menus para cada perfil --}}
