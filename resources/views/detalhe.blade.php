 ...
 <header>
  <nav class="navbar fixed-top navbar-dark">
    <div class="container-sm">
      ...
      <div class="order-1 logo text-center img-fluid">
        <a href="{{ route('home') }}">
          <img src="{{ asset('/images/logo/logo_dpa.png') }}" width="120px" alt="diário do Pará">
        </a>
      </div>

      <div class="order-2">
        <a href="https://dol.com.br/digital/" class="btn btn-secondary" role="button" aria-pressed="true" target="_blank">Edição Eletrônica</a>
      </div>
    </div>
  </nav>
</header>
